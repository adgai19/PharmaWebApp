package com.psl.demoProj.utils;

import javax.servlet.http.Cookie;
import javax.servlet.http.HttpServletRequest;
import javax.servlet.http.HttpServletResponse;

import com.psl.demoProj.auth.models.SecurityProperties;
...
public class CookieUtils {
    ...
    public void setCookie(String name,String value,int expiryInMin) {
        int expInSec=expiryInMin*60*60;
